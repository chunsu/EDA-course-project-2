...
- Have total emissions from PM2.5 decreased in the Baltimore City, Maryland <span style="color:red">fips</span> (fips=="24510") from 1999 to 2008? Use the base plotting system to make a plot answering this question.
